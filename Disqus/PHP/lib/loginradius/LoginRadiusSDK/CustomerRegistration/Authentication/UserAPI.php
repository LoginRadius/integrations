...
class UserAPI {
    ...
    public function register($userprofile, $verification_url = '', $email_template = '', $sms_template = '', $fields = '*') {
        ...
        return $this->apiClientHandler("register", array('sott' => $encrypt->Sott, 'verificationUrl' => $verification_url, 'emailTemplate' => $email_template, 'smsTemplate' => $sms_template, 'fields' => $fields), array('method' => 'post', 'post_data' => $userprofile, 'content_type' => 'json'));
    }
